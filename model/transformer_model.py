...
# Load the tokenizer dictionary
    ...
    model.load_state_dict(torch.load('/root/test/text2midi/output_test_lr_symph_ft/epoch_140/pytorch_model.bin', map_location=device))
    model.eval()
    ...
    output_list = output[0].tolist()
    generated_midi = r_tokenizer.decode(output_list)
    generated_midi.dump_midi(f"../../output_e3_epoch_140.mid")
